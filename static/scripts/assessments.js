...
function progressFormatter(progress) {
	return `
		<div class="progress">
			<div class="progress-bar bg-info" role="progressbar" style="width: ${progress.split('|')[0]}%"></div>
			...
			<div class="progress-bar bg-danger" role="progressbar" style="width: ${progress.split('|')[3]}%"></div>
		</div>
	`
}
